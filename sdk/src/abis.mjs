...
export const multiChainRuleTuple =
...
export const portfolioPoolV1Abi = [
  ...
  "function maximumPoolAssets() view returns (uint256)",
  "function maximumServiceBudget() view returns (uint256)",
  "function maximumServiceJobDuration() view returns (uint64)",
  ...
  "function mandate() view returns (address)",
  "function proofJobsVenue() view returns (address)",
  "function status() view returns (uint8)",
  "function totalDeposited() view returns (uint256)",
  "function totalAllocatedPrincipal() view returns (uint256)",
  "function totalRecovered() view returns (uint256)",
  "function totalRealizedLoss() view returns (uint256)",
  "function totalServiceEscrowed() view returns (uint256)",
  "function totalServiceRecovered() view returns (uint256)",
  "function allocatedFacilityCount() view returns (uint256)",
  "function settledFacilityCount() view returns (uint256)",
  "function totalDistributed() view returns (uint256)",
  "function totalClaimed() view returns (uint256)",
  "function isCreatedFacility(address facility) view returns (bool created)",
  "function isInvestor(address account) view returns (bool investor)",
  "function claimedAssets(address account) view returns (uint256 amount)",
  "function isPoolProofJob(uint256 jobId) view returns (bool created)",
  "function remedyPolicyEvaluator(address facility,uint256 policyId) view returns (address evaluator)",
  "function remedyCoordinator(address facility,uint256 policyId) view returns (address coordinator)",
  `function allocationOf(address facility) view returns (${portfolioPoolAllocationTuple})`,
  "function claimable(address account) view returns (uint256)",
  "function createdFacilityCount() view returns (uint256)",
  "function createdFacilityAt(uint256 index) view returns (address)",
  "function candidateCount() view returns (uint256)",
  "function candidateAt(uint256 index) view returns (address)",
  "function investorCount() view returns (uint256)",
  "function investorAt(uint256 index) view returns (address)",
  "function name() view returns (string)",
  "function symbol() view returns (string)",
  ...
  "function transfer(address to,uint256 value) returns (bool)",
  "function transferFrom(address from,address to,uint256 value) returns (bool)",
  "function setMandate(address mandate_)",
  ...
  "function configureAndRegisterPolicy(address facility,uint256 policyId,address evaluator,bytes configurationCall)",
  "function authorizeRemedyPolicy(address facility,uint256 policyId,address coordinator)",
  "function publishRemedyIntent(address facility,uint256 policyId,bytes actionData) returns (bytes32 messageId)",
  "function replaceRemedyIntent(address facility,uint256 policyId) returns (bytes32 intentId)",
  "function registerCandidate(address facility,bytes32 deploymentId)",
  "function registerInvestor(address investor)",
  "function setProofJobsVenue(address proofJobs_)",
  "function openFunding()",
  "function deposit(uint256 amount)",
  "function withdrawFunding(uint256 amount)",
  "function cancelFunding()",
  "function activate()",
  "function allocate(address facility,uint256 amount)",
  "function setFacilityDrawPaused(address facility,bool paused)",
  `function createProofJob(${proofJobParamsTuple} params) returns (uint256 jobId)`,
  "function recoverProofJobFunds() returns (uint256 recovered)",
  "function harvest(address facility) returns (uint256 recovered)",
  "function settleAllocation(address facility)",
  "function finalize()",
  "function distributeAvailable() returns (uint256 amount)",
  ...
  "event RemedyIntentPublished(address indexed facility,uint256 indexed policyId,bytes32 indexed intentId,bytes32 messageId)",
  ...
  "error IneligibleFacility(uint8 code)",
  "error InvalidAmount()",
...
export const cappedPilotFactoryV1Abi = [
  "function asset() view returns (address)",
  "function kernel() view returns (address)",
  "function lender() view returns (address)",
  "function borrower() view returns (address)",
  ...
  "function minimumBondBps() view returns (uint16)",
  "function maximumDrawFeeBps() view returns (uint16)",
  "function maximumMaturityBlocks() view returns (uint64)",
  "function maximumDrawDelayBlocks() view returns (uint32)",
  "function maximumFacilityCount() view returns (uint16)",
  "function creationPaused() view returns (bool)",
  "function totalFacilityLimit() view returns (uint256)",
  "function isFacility(address facility) view returns (bool created)",
  "function facilityCount() view returns (uint256)",
  "function facilityAt(uint256 index) view returns (address)",
  "function setCreationPaused(bool paused)",
  "function createFacility(uint256 facilityLimit,uint256 bondRequired,uint16 drawFeeBps,uint64 maturityBlock,uint32 drawDelayBlocks) returns (address facility)",
...
export const recourseFacilityV3Abi = [
  ...
  "function settleDefaultLoss()",
  "event DefaultLossSettled(uint256 lenderRecovery,uint256 borrowerExcess,uint256 remainingDebt)",
];

export const policyKernelV2Abi = [
  "function verifier() view returns (address)",
  "function creditState() view returns (address)",
  "function owner() view returns (address)",
  "function proofJobs() view returns (address)",
  "function safeStaleProofRelease() pure returns (bool)",
  "function policySetCommitment(address facility) view returns (bytes32 commitment)",
  "function registerPolicy(address facility,uint256 policyId,address evaluator)",
  `function submitSingle(address facility,uint256 policyId,uint64 chainKey,uint64 height,bytes encodedTransaction,${merkleProofTuple} merkleProof,${continuityProofTuple} continuityProof) returns (uint8 outcome)`,
  `function submitBatch(address facility,uint256 policyId,uint64 chainKey,uint64[] heights,bytes[] encodedTransactions,${merkleProofTuple}[] merkleProofs,${continuityProofTuple} sharedContinuityProof) returns (uint8 outcome)`,
  "function setProofJobs(address proofJobs_)",
  "function incidentPaused(address facility) view returns (bool)",
  "function canPublishJob(address facility,address sponsor,address token,uint256 policyId,bytes32 requirementsDigest) view returns (bool)",
  "function evaluateProofJob(address facility,uint256 policyId,bytes32 requirementsDigest,bytes proof,address hunter) returns (bool accepted,uint8 outcomeLevel)",
  "function policyOf(address facility,uint256 policyId) view returns (address evaluator,bytes32 configHash,bytes manifestBytes)",
...
export const multiChainEventPolicyV1Abi = [
  "function MAXIMUM_RULES() view returns (uint256)",
  "function context() view returns (address)",
  `function configure(address facility,uint256 policyId,${multiChainConfigurationTuple} configuration)`,
  `function evaluate(address facility,uint256 policyId,${provenTransactionTuple}[] proven) returns (${policyResultTuple} result)`,
  `function configurationOf(address facility,uint256 policyId) view returns (${multiChainConfigurationTuple} output)`,
  "function isConfigured(address facility,uint256 policyId) view returns (bool)",
  "function configHash(address facility,uint256 policyId) view returns (bytes32)",
  "function manifest(address facility,uint256 policyId) view returns (bytes)",
  "function policyKind() pure returns (string)",
  "function sourceOrdering() pure returns (uint8)",
...
export const operatorMarketV1Abi = [
  ...
  "function verifier() view returns (address)",
  "function minimumOperatorBond() view returns (uint256)",
  "function maximumQuoteDuration() view returns (uint64)",
  "function maximumServiceDuration() view returns (uint64)",
  ...
  "function expireQuote(uint256 quoteId)",
  "function withdraw()",
  "function agreementIdOf(uint256 quoteId,address sponsor) view returns (bytes32)",
...
export const v3Abis = Object.freeze({
  CappedPilotFactoryV1: cappedPilotFactoryV1Abi,
  RecourseFacilityV3: recourseFacilityV3Abi,
  PolicyKernelV2: policyKernelV2Abi,
  MultiChainEventPolicyV1: multiChainEventPolicyV1Abi,
  OperatorMarketV1: operatorMarketV1Abi,
  PortfolioMandateV1: portfolioMandateV1Abi,
  PortfolioPoolV1: portfolioPoolV1Abi,
});
