...
**Honest dependencies:** The pool is deployed in Configuring state, unaudited, uncapitalized, and not an evergreen NAV product; shares lock after activation and only exact fixed-vintage allocations are supported. Meaningful live history, lender demand, legal structuring, custody review, valuation inputs, and audited loss accounting remain gates. It should follow successful bilateral facilities, not precede them.
